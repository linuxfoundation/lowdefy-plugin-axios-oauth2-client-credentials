...
connectionSchema.auth = {
  ...
  properties: {
    tokenUrl: {
      type: "string",
      description:
        "OAuth2 token URL to POST the credential_credentials grant request.",
      errorMessage: {
    ...
    clientId: {
      type: "string",
      description:
        "The Client ID that this application uses to authorize itself to the authentication server.",
      errorMessage: {
    ...
    clientSecret: {
      type: "string",
      description:
        "The Client Secret that this application uses to authorize itself to the authentication server.",
      errorMessage: {
    ...
    endpointParams: {
      type: "object",
      description:
        "Additional parameters for the token request, e.g. audience.",
      errorMessage: {
